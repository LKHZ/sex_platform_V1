...
class star(imdb):
    def __init__(self, image_set, data_path):
        ...
        self._devkit_path = '/home/lab30201/sdb/slc/sex_platform_V1/detection_sex/data'
    ...
    def _load_star_txt(self,indx):         ##  change from _load_pascal_annotation(self,indx)
        ...
        #print(starposfilenametmp)
        array_from_txt  = np.loadtxt(starposfilenametmp)
        objs_all_list = []
        for step, value_single_row in enumerate(array_from_txt):
            if 10 < array_from_txt[step][1] < 290 and 10 < array_from_txt[step][2] < 290:  ##  remove nagative coordinate
...
if __name__ == '__main__':
    d = star('train', '/home/lab30201/sdb/slc/sex_platform_V1/triandata300-300')
    res = d.roidb
