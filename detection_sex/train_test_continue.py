...
def parse_args():
	...
	parser.add_argument('--save_dir', dest='save_dir',
	                    help='directory to save models', default="/home/lab30201/sdb/slc/sex_platform_V1/detection_sex/model_save",
...
if __name__ == '__main__':
	...
	for epoch in range(args.start_epoch, args.max_epochs):
		...
		if mean_ap >= best_map:
			...
			for key in recs.keys():
				...
				plt.savefig(
					'/home/lab30201/sdb/slc/sex_platform_V1/detection_sex/output/visiual_map_loss/session{}_{}_PR.jpg'.format(
						args.session, key))
				plt.close()
		map.append(mean_ap)
	...
	plt.savefig(
		'/home/lab30201/sdb/slc/sex_platform_V1/detection_sex/output/visiual_map_loss/session{}test_map.jpg'.format(
			args.session))
	plt.close()
	print("completed!!!")
