...
def parse_args():
	...
	parser.add_argument('--load_dir', dest='load_dir',
	                    help='directory to load models', default="/home/lab30202/sdb/liuqiang/2019-12-3-SH/code/sex_platform/detection_sex/model_save",
	                    nargs=argparse.REMAINDER)
	...
	parser.add_argument('--image_dir', dest='image_dir',
	                    ...
	                    default="/home/lab30202/sdb/liuqiang/2019-12-3-SH/code/sex_platform/detection_sex/validation")
...
if __name__ == '__main__':
	...
	pascal_classes = np.asarray(['__background__','star'])
	...
	while (num_images >= 0):
		...
		for j in range(1, len(pascal_classes)):
			...
			if inds.numel() > 0:
				...
				if vis:
					im2show = vis_detections(im2show, pascal_classes[j], cls_dets, 0.5)
